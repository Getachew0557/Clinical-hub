...
export const patients = [
    { id: 'P001', name: 'John Anderson', phone: '+1 555-0101', email: 'john.anderson@email.com', gender: 'Male', age: 35, address: '123 Main St, Springfield', allergies: ['Penicillin'], medicalHistory: 'Root canal (2023), Teeth whitening (2024)', registeredDate: '2023-06-15', lastVisit: '2026-02-10', status: 'Active' },
    { id: 'P002', name: 'Emily Roberts', phone: '+1 555-0102', email: 'emily.roberts@email.com', gender: 'Female', age: 28, address: '456 Oak Ave, Springfield', allergies: [], medicalHistory: 'Cleaning (2024), Filling (2025)', registeredDate: '2024-01-20', lastVisit: '2026-02-15', status: 'Active' },
    { id: 'P003', name: 'Michael Chen', phone: '+1 555-0103', email: 'michael.chen@email.com', gender: 'Male', age: 42, address: '789 Pine Rd, Shelbyville', allergies: ['Latex', 'Lidocaine'], medicalHistory: 'Crown placement (2024), Extraction (2025)', registeredDate: '2024-03-10', lastVisit: '2026-01-28', status: 'Active' },
    { id: 'P004', name: 'Sarah Williams', phone: '+1 555-0104', email: 'sarah.williams@email.com', gender: 'Female', age: 31, address: '321 Elm Blvd, Capital City', allergies: ['Aspirin'], medicalHistory: 'Braces (2023-2025), Retainer fitting (2025)', registeredDate: '2023-01-05', lastVisit: '2026-02-18', status: 'Active' },
    { id: 'P005', name: 'David Kim', phone: '+1 555-0105', email: 'david.kim@email.com', gender: 'Male', age: 55, address: '654 Birch Ln, Ogdenville', allergies: [], medicalHistory: 'Implant (2024), Periodontal treatment (2025)', registeredDate: '2024-06-22', lastVisit: '2026-02-05', status: 'Active' },
    { id: 'P006', name: 'Lisa Thompson', phone: '+1 555-0106', email: 'lisa.thompson@email.com', gender: 'Female', age: 22, address: '987 Cedar Dr, North Haverbrook', allergies: [], medicalHistory: 'Wisdom teeth removal (2025)', registeredDate: '2025-01-12', lastVisit: '2025-11-20', status: 'Inactive' },
    { id: 'P007', name: 'Robert Martinez', phone: '+1 555-0107', email: 'robert.martinez@email.com', gender: 'Male', age: 48, address: '147 Maple St, Springfield', allergies: ['Codeine'], medicalHistory: 'Dentures (2024), Adjustment (2025)', registeredDate: '2024-08-30', lastVisit: '2026-02-12', status: 'Active' },
    { id: 'P008', name: 'Jennifer Lee', phone: '+1 555-0108', email: 'jennifer.lee@email.com', gender: 'Female', age: 37, address: '258 Walnut Ave, Shelbyville', allergies: [], medicalHistory: 'Veneer (2025), Cleaning (2026)', registeredDate: '2025-03-18', lastVisit: '2026-02-19', status: 'Active' },
];
